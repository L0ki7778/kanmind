...
class TaskListCreateSerializer(serializers.ModelSerializer):
    assignee = SimpleUserSerializer(read_only=True) # Serializer get's used to display the needed data only
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'status', 'priority',
                  'due_date', 'comments_count', 'board', 'assignee', 'reviewer', 'assignee_id',
                  'reviewer_id']
