...
from .views import TaskListCreateView,TaskUpdateDeleteView,TaskListAssignedView,TaskListReviewerView,TaskCommentsListCreateView
...
urlpatterns = [
    ...
    path('<int:task_id>/comments/<int:comment_id>/', TaskUpdateDeleteView.as_view(), name='delete_comments'),
